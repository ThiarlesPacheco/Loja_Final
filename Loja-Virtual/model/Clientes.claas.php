            ...
            if($this->GetClienteCPF($this->getCli_cpf()) > 0)
            {
                echo '
                    <section class="arrivals" id="erro_mostrar">
                        ...
                        <h2 class="text-3xl font-medium text-white-600">Este CPF já existe!</h2>
                        </div>
            ...
            if($this->GetClienteEmail($this->getCli_email()) > 0)
            {
                echo '
                    <section class="arrivals" id="erro_mostrar">
                        ...
                        <div class="flex items-center justify-center px-4 sm:px-6 lg:px-8 my-10 bg-red-600">
                        <h2 class="text-3xl font-medium text-white-600">Este Email já existe!</h2>
                        </div>
                ';
                Sistema::VoltarPagina();
                echo '</section>';
        ...
        function Editar($id){
          ...
          if($this->GetClienteCPF($this->getCli_cpf()) > 0 && $this->getCli_cpf() != $_SESSION['CLI']['cli_cpf']):
                ...
                <section class="arrivals" id="erro_mostrar">
                    ...
                    <div class="flex items-center justify-center px-4 sm:px-6 lg:px-8 my-10 bg-red-600">
                    <h2 class="text-3xl font-medium text-white-600">Este CPF já esta cadastrado</h2>
                    </div>
                ';
                Sistema::VoltarPagina();
                echo '</section>';
            ...
            if($this->GetClienteEmail($this->getCli_email()) > 0 && $this->getCli_email() != $_SESSION['CLI']['cli_email']):
                ...
                <section class="arrivals" id="erro_mostrar">
                    ...
                    <div class="flex items-center justify-center px-4 sm:px-6 lg:px-8 my-10 bg-red-600">
                    <h2 class="text-3xl font-medium text-white-600">Este Email já esta cadastrado</h2>
                    </div>
                ';
                Sistema::VoltarPagina();
                echo '</section>';
