<?php
    ...
    class Pedidos extends Conexao {
        ...
        function GravarPedido($cliente, $cod, $ref, $freteValor=null, $freteTipo=null)
        {
            $retorno = false;
        ...
        function GetPedidosCliente($cliente = null)
        {
            ...
            if($cliente  != null)
            {
                ...
                $query .= $this->PaginacaoLinks("ped_id", $this->prefix."pedidos WHERE PED_ID =".(int)$cli);
            } else{
                $query .= $this->PaginacaoLinks("ped_cliente", $this->prefix."pedidos");
            }
