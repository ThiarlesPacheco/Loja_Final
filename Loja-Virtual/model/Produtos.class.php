<?php
    ...
    Class Produtos extends Conexao
    {
        ...
        //PEGAR PRODUTO POR ID => INFORMAÇÃO DO PRODUTO ESPECÍFICO
        function GetProdutosID($id)
        {
            //VERIFICAR SE O ID PASSADO PELA URL, É UM VALOR VÁLIDO E INTEIRO
            ...
            // (int)$id => Verificação para somente aceitar valor inteiro

            $params = array(':id'=>(int)$id); //Recebdendo o parâmetro passado pela query

            //EXECUTANDO A QUERY
            $this->ExecuteSQL($query, $params);

            //RETORNANDO A LISTA DO BANCO
            $this->GetListas();
        }

        //PEGAR PRODUTOS POR CATEGORIAS => INFORMAÇÃO DO PRODUTO ESPECÍFICO
        ...
        //PEGANDO OS ITENS DA TABELA PRODUTO DO BANCO DE DADOS
        private function GetListas()
        {
            ...
            $this->itens[$i] = array(
                ...
                'pro_img' => Rotas::ImageLink($lista['pro_img'], 880, 880),
