    ...
    <div class="row">
        ...
        <div class="flex  justify-between gap-4">
            ...
            <div style="width: 20%;">
                ...
                <input data-aos="zoom-in" type="text" value="{$CLI_CPF}" class="box" name="cli_cpf" id="cli_cpf">
            </div>
        ...
        <div class="flex  justify-between gap-4">
            ...
            <div style="width: 50%;">
                <input data-aos="zoom-in" type="hidden" class="box" name="cli_id" value="{$CLI_ID}" required>
            </div>
        </div>
