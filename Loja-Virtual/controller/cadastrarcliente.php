    ...
    if(isset($_POST['cli_nome']) && isset($_POST['cli_email']) && isset($_POST['cli_cpf']))
    {
        ...
        echo '
            <section class="arrivals" id="erro_mostrar">
                ...
                <h2 class="text-3xl font-medium text-white-600">Cadastro feito com sucesso!</h2>
                <h2 class="text-3xl font-medium text-white-600">A senha para fazer login foi enviada para o seu email! </h2> <span class="text-3xl font-medium text-orange-600"> Acesse seu email para conferir!</span>
                </div>
